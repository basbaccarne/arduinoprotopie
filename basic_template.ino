/* 
this code is the basic Arduino code to send some data and receive some data over serial
by Bas Baccarne

input: rotary sensor - variable name "rotary" // values 0 to 100
output: neopixel ledring - variable "ledring" // values 0 to 24 (the ledring has 24 leds)
*/
